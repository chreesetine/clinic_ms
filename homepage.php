...
<html>
    ...
    <body>
        ...
        <section class="home" id="home">
            <div class="text">
                ...
                <h5>to students, faculty 
                    members & non-teaching personnel of BSU-SC.</h5>
                </center>
            </div>
                ...
                <div class="form sign_form">
                    ...
                    <form action="config.php" method="post">
                        ...
                        <div class="captcha-container">
                           <!-- <label for="captcha">Enter the CAPTCHA code:</label><br>
                            <input type="text" id="captcha" name="captcha"><br>
                            <img src="captcha.php" id="captcha-image" alt="CAPTCHA" title="Click to change">-->

                            <label for="captcha">Captcha: </label><br>
                            <input type="text" id="captcha" name="captcha"><br>
                            <img id="captcha-img" src="captcha.php" alt="Captcha"><br>
                            <button type="button" id="refresh-captcha">Refresh Captcha</button>
                        </div>

                       <!-- <div class="row">
                            <div class="col">
                            <label for="for-label">Enter Captcha:</label>
                                <div class="preview"></div>
                                 <input type="text" class="form-control" id="captcha-form" placeholder="Enter captcha text" required>
                                 <button class="captcha-refresh">
                                      <i class='bx bx-refresh' width="30px" height="30px"></i>
                                 </button>
                            </div>
                        </div>-->
        ...
        <script>
            ...
            document.getElementById('captcha-img').src = 'captcha.php?' + Math.floor(Math.random() * 100);
            });
